...
public class Game2048Test {
    ...
    void gameTest() {
        ...
        Board<String, Key> b2 = new SquareBoard<>(1);
        ...
        Board<Double, String> b3 = new Board<>(1, 1) {
            ...
            @Override
            public List<Double> getColumnValue(int j) {
                return null;
            }

            @Override
            public List<Double> getRowsValue(int i) {
                return null;
            }
        ...
        Board<Integer, Key> b = game.getGameBoard();
